...
QA_DIR="$ROOT_DIR/artifacts/qa/m5.1-$STAMP"
LOG_FILE="$QA_DIR/validate-m51.log"
...
printf 'M5.1 validation started at %s\n' "$(date -u --iso-8601=seconds)"
printf 'git_head=%s\n' "$(git rev-parse HEAD)"
...
shellcheck scripts/*.sh installers/linux/*.sh
...
printf 'M5.1 validation passed at %s\n' "$(date -u --iso-8601=seconds)"
