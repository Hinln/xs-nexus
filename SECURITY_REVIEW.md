...
- Residual risk remains High: 157 upgrades plus 9 new dependency packages are pending in the simulated dist-upgrade, including 119 security-source operations; root usage is `83%`; external disk-alert delivery is absent. Gate 14 is therefore `PARTIAL`, and the overall release remains `NO_GO`.
