...
当前仅有平台无关 ABI/会话测试和 UMDF 源码不变量检查。`xsnet.vcxproj`、INF、DriverEntry、file object、IOCTL、PnP/power 与断链队列骨架尚未经过 WDK、InfVerif、签名或 VM；所有 K 项保持未勾选。Windows 10 官方支持冲突见 `KI-016`。
