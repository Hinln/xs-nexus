...
.PHONY: setup fmt fmt-check lint build test test-unit test-integration test-controller-db test-controller-scale test-protocol-throughput test-relay-throughput test-agent-control test-agent-systemd test-agent-data-plane test-agent-candidate-fallback test-agent-candidate-path test-agent-candidates test-agent-proactive-punch test-agent-nat-matrix test-agent-nat test-agent-relay test-agent-acl test-agent-subnet-route test-linux-installer test-docker-deployment test-runtime-stability test-windows-xsnet-abi test-windows-xsnet-source test-windows-xsnet-installer test-windows-xsnet-vm-scripts test-windows-xsnet-compatibility test-windows-xsnet-transport test-windows-agent-ipc test-windows-agent-storage test-windows-agent-routing test-windows-agent-service test-independent-implementation test-source-sbom test-image-sbom source-sbom validate-image-supply-chain scan-image-vulnerabilities verify-image-vulnerability-disposition test-protocol-vectors test-spec test-network test-e2e test-visual security-check linux-package-x86_64 linux-package-aarch64 linux-packages validate-m21 validate-m22 validate-m23 validate-m31 validate-m32 validate-m42 validate-m51 validate-m52 validate-m61-agent-session release clean
