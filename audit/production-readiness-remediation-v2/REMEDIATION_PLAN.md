...
- Latest exact code candidate `a44d868c26e21285565fa794d482b8092c0bbbf4` passed all 14 jobs in run `31671264821`; job `94356192850` and artifact `9170104931` independently passed its complete manifest and zero secret findings.
...
- Exact code candidate `a44d868c26e21285565fa794d482b8092c0bbbf4` passed all 14 jobs in run `31671264821`; job `94356192877` and artifact `9170135871` passed its complete outer/nested manifests and zero secret findings.
