...
- Latest exact revision `6e63424298e491c0035e1d138de5d03b0ab83c27` passed all 13 jobs in run `31649030446`; job `94289075250` and artifact `9162201059` independently passed 84/84 hashes and zero secret findings.
...
- Exact revision `6e63424298e491c0035e1d138de5d03b0ab83c27` passed all 13 jobs in run `31649030446`; job `94289075249` and artifact `9162246723` passed 111/111 hashes and zero secret findings.
- Six retained failed runs expose shallow history, Buildx context, PostgreSQL lifecycle, Docker firewall initialization, database startup race/performance transition, and hosted-runner hardware hot-plug behavior. No phase, threshold, or cleanup assertion was skipped.
