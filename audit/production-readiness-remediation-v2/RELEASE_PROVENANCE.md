...
The later Gate 23 implementation head `3bf861922c8b3cc62c3bfd1617835565fd86fc6b` passed GitHub Actions run [`31313868529`](https://github.com/Hinln/xs-nexus/actions/runs/31313868529), clean-checkout dependency/security validation, real Console E2E, protocol fuzz, and double no-cache image reproducibility. It was not deployed, tagged as a formal RC, merged to `main`, or signed with an owner-controlled release key. Runtime provenance therefore continues to terminate at deployed `3d93656`, not branch head `3bf8619`.
