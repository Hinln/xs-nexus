...
- [ ] Host, PostgreSQL, planned-domain TLS, observability, defects, dependency, and deployment gates are `PASS`.
...
- [ ] Git worktree is clean, CI passes, release manifest/signatures verify, and production upgrade plus rollback are complete.
